...
REM
REM Generated by Vivado on Thu Mar 24 11:16:44 +0100 2022
...
echo "xvlog --incr --relax -prj tb_maszyna_stanow_vlog.prj"
call xvlog  --incr --relax -prj tb_maszyna_stanow_vlog.prj -log xvlog.log
